---
name: cleancode
description: Clean Code practices for Java 21 + Spring Boot APIs. Generate simple, readable, and maintainable code with proper separation of concerns (Controller/Service/Model/DTO), clear naming, small methods, and no business logic in controllers.
---

# Clean Code para Java + Spring Boot
